...
<h1 style="margin-top: 50px; margin-bottom: 100px;">Clientes</h1>

<div class="row text-left">
<a href='/customer/create' style="color: #fff;"><button class="btn text-left btn-danger">Nuevo cliente</button></a>
</div>
